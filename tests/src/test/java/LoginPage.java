...
public class LoginPage extends PageBase {
    private By userNameTextField = By.xpath("//input[@id='email_login']");
    private By passwordTextField = By.xpath("//input[@id='password_login']");
    private By loginButton = By.xpath("//div[contains(@class, 'sr-login-row-login-button')]//button[contains(@class, 'btn-lg')]");
